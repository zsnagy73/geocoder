...
namespace Drupal\Tests\geocoder_geolocation\Kernel;
...
/**
 * Tests the integration between geocoder with geolocation.
 *
 * @group geocoder
 */
class GeocoderGeolocationIntegrationTest extends KernelTestBase {

  /**
   * {@inheritdoc}
   */
  public static $modules = ['geophp', 'geolocation', 'field', 'geocoder_geolocation', 'geocoder_geolocation_test', 'geocoder', 'geocoder_field', 'entity_test', 'text', 'user', 'filter'];

  /**
   * Tests the geocoding on Geolocation field type.
   */
